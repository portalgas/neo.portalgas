...
Router::prefix('admin', function (RouteBuilder $routes) {
    ...
    $routes->prefix('api', function(RouteBuilder $routes) {
        ...
        $routes->scope('/exports', ['controller' => 'Exports'], function (RouteBuilder $routes) {
            ...
            $routes->connect('/user-cart-splits-by-families', ['action' => 'userCartSplitsByFamilies', '_method' => 'GET']);
            $routes->connect('/user-cart-splits-by-articles', ['action' => 'userCartSplitsByArticles', '_method' => 'GET']);
