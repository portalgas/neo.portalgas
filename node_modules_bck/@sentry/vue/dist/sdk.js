...
function init(options) {
    ...
    if (finalOptions.Vue === undefined) {
        utils_1.logger.warn('No Vue instance was provided. Also there is no Vue instance on the `window` object.');
        utils_1.logger.warn('We will only capture global unhandled errors.');
    }
    else {
...
var VueHelper = /** @class */ (function () {
    ...
    VueHelper.prototype._startTracing = function () {
        ...
        var appliedTracingHooks = setTimeout(function () {
            utils_1.logger.warn("Didn't apply tracing hooks, make sure you call Sentry.init before initialzing Vue!");
        }, 500);
