<template>
	...
	<div class="tab" v-show="isActive">
		...
		<orders-deliveries v-if="url=='/admin/api/deliveries/gets/0'" :datas="datas" :dataNotFound="dataNotFound"></orders-deliveries>

    <orders-suppliers v-if="url=='/admin/api/orders/gets/0'" :datas="datas" :dataNotFound="dataNotFound"></orders-suppliers>

    <orders-suppliers v-if="url=='/admin/api/orders/gets/9'" :datas="datas" :dataNotFound="dataNotFound"></orders-suppliers>
