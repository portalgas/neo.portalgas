  ...
  <main>
    ...
    <div class="row">
      ...
      <div class="col-md-3" style="text-align:center;">
        <a class="btn btn-primary" href="https://www.portalgas.it/gestionale-web-gas" title="presentazione del gestionale web per GAS">Ci presentiamo</a>
      </div>
      ...
      <div class="col-md-6">
          ...
          <p>Il cuore del progetto è l'idea di partire da uno strumento di e-commerce (<strong>semplice</strong> ed <strong>intuitivo</strong>) integrando le funzionalità tipiche degli acquisti dei GAS (<span>gruppi d'acquisto solidale</span>).</p>
          ...
          <p>L'attore principale è il <strong>referente</strong> di prodotto, coadiuvato dal responsabile del GAS e da altre figure di aiuto (Tesoriere, Co-referente...)</p>
          <p>Anche i <strong>produttori</strong> hanno un ruolo fondamentale per i Gas, avere la possibilità di poter consultare un archivio dei Produttori comune a tutti i GAS aderenti è a nostro avviso un vantaggio.</p>
          ...
          <a href="https://www.portalgas.it/gestionale-web-gas" title="presentazione del gestionale web per GAS"><button class="btn btn-primary" type="button">guarda la presentazione</button></a>

          <h2 style="margin-top: 20px;">Cosa fa Portalgas</h2>
          ...
          <li>Avanzamento Stati Ordini</li>
          <ol>
      ...
      <div class="col-md-3" style="text-align:center;">
        <a class="btn btn-primary" href="https://manuali.portalgas.it/" target="_blank" title="manuale per gasista e referente degli ordini del GAS">
          Manuale
        </a>
      </div>
