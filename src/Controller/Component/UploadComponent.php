...
/*
	...
	$this->Upload->output()
		'file_name' => 'file.xml',
		'file_type' => 'text/xml',
		'file_path' => '/var/www/site/webroot/',
		'full_path' => '/var/www/site/webroot/file.xml',
		'raw_name' => 'file',
		'orig_name' => 'file.xml',
		'client_name' => 'file.xml',
		'file_ext' => '.xml',
		'file_size' => (float) 2.71,
		'is_image' => false,
		'image_width' => null,
		'image_height' => null,
		'image_type' => '',
...
class UploadComponent extends Component {
	 ...
	 */
	public function readXml($field = 'file') {
		$esito = $this->_upload($field);
		if($esito) {
	...
	/**
	 * fa solo l'upload ma non copia il file
	 */
