 ...
 * @method \App\Model\Entity\MovementType|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
...
{
    const MODEL_USERS = 'Gasisti';
    const MODEL_SUPPLIERS = 'Produttori';    
