      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <dl class="dl-horizontal">
            ...
            <dd><?= h($documentOwnerModel->code) ?></dd>
            <dt scope="row"><?= __('Name') ?></dt>
            <dd><?= h($documentOwnerModel->name) ?></dd>
            <dt scope="row"><?= __('Id') ?></dt>
            <dd><?= $this->Number->format($documentOwnerModel->id) ?></dd>
            <dt scope="row"><?= __('Sort') ?></dt>
            <dd><?= $this->Number->format($documentOwnerModel->sort) ?></dd>
            <dt scope="row"><?= __('Created') ?></dt>
            <dd><?= h($documentOwnerModel->created) ?></dd>
            <dt scope="row"><?= __('Modified') ?></dt>
            <dd><?= h($documentOwnerModel->modified) ?></dd>
            <dt scope="row"><?= __('Is System') ?></dt>
            <dd><?= $documentOwnerModel->is_system ? __('Yes') : __('No'); ?></dd>
            <dt scope="row"><?= __('Is Active') ?></dt>
            <dd><?= $documentOwnerModel->is_active ? __('Yes') : __('No'); ?></dd>
            <dt scope="row"><?= __('Is Default Ini') ?></dt>
            <dd><?= $documentOwnerModel->is_default_ini ? __('Yes') : __('No'); ?></dd>
            <dt scope="row"><?= __('Is Default End') ?></dt>
            <dd><?= $documentOwnerModel->is_default_end ? __('Yes') : __('No'); ?></dd>
          </dl>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-solid">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <?= $this->Text->autoParagraph($documentOwnerModel->descri); ?>
        </div>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="box box-solid">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <?php if (!empty($documentOwnerModel->documents)): ?>
          <table class="table table-hover">
              ...
              <?php foreach ($documentOwnerModel->documents as $documents): ?>
              <tr>
