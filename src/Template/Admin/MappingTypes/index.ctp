            ...
            <tbody>
              <?php foreach ($mappingTypes as $mappingType): ?>
                <tr>
                  ...
                  <td class="text-center"><?= $this->HtmlCustom->drawTruFalse($mappingType, $mappingType->is_system); ?></td>
                  <td class="text-center"><?= $this->HtmlCustom->drawTruFalse($mappingType, $mappingType->is_active); ?></td>
