...
echo $this->HtmlCustomSite->boxTitle(['title' => __('Movement'), 'subtitle' => __('Add')], ['home', 'list']);
/*
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          echo $this->Form->control('year', ['default' => date('Y')]);
          echo '</div>';
          echo '</div>'; // row
          ...
          echo '</div>';
          echo '<div class="col-md-6">';
          echo $this->Form->radio('payment_type', $payment_types, ['default' => 'ALTRO']);
          echo '</div>';
          echo '</div>'; // row
