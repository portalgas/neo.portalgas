 ...
 * @var \App\Model\Entity\KProdGasArticlesPromotion $kProdGasArticlesPromotion
 */
?>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <?php echo $this->Form->create($kProdGasArticlesPromotion, ['role' => 'form']); ?>
            <div class="box-body">
              <?php
                ...
                echo $this->Form->control('prezzo_unita');
