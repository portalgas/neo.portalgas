 ...
 * @var \App\Model\Entity\KProdGasPromotionsOrganizationsDelivery $kProdGasPromotionsOrganizationsDelivery
 */
?>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <?php echo $this->Form->create($kProdGasPromotionsOrganizationsDelivery, ['role' => 'form']); ?>
            <div class="box-body">
              <?php
                ...
                echo $this->Form->control('isConfirmed');
              ?>
            </div>
            <!-- /.box-body -->
