  ...
  <tbody>
    ...
    foreach ($documents as $document):
        ...
        echo '<td class="actions text-right">';
            ...
            echo '<a href="/admin/documents/organization-edit/'.$document->id.'/'.$document->document_reference_id.'/'.$document->document_reference_model_id.'/'.$document->document_owner_id.'/'.$document->document_owner_model_id.'" ';
            ...
            if(!$document->is_system) {
                ...
                echo $this->Form->postLink(__('Delete'), ['controller' => 'documents', 'action' => 'organizationdelete', $document->id], 
...
if(empty($document_owner_model_id))
    ...
    echo '<a href="/admin/documents/organization-add/'.$document_reference_id.'/'.$document_reference_model_id.'/'.$document_owner_id.'/'.$document_owner_model_id.'" ';
