...
class CmsDocsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cms_menu_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'size' => 1,
                'created' => '2025-03-18 16:57:05',
                'modified' => '2025-03-18 16:57:05',
            ],
        ];
        parent::init();
    }
