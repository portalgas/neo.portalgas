...
class CmsMenusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cms_menu_type_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_system' => 1,
                'is_active' => 1,
                'created' => '2025-03-13 18:09:48',
                'modified' => '2025-03-13 18:09:48',
            ],
        ];
        parent::init();
    }
