...
/**
 * CmsPageImagesFixture
 */
class CmsPageImagesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'ext' => ['type' => 'string', 'length' => 75, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'size' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'size' => 1,
                'sort' => 1,
                'created' => '2025-03-18 16:57:09',
                'modified' => '2025-03-18 16:57:09',
            ],
        ];
        parent::init();
    }
