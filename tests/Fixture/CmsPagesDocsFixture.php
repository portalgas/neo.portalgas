 ...
 * CmsPagesDocsFixture
 */
class CmsPagesDocsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'cms_doc_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'cms_doc_id' => 1,
                'sort' => 1,
                'created' => '2025-03-20 11:31:10',
                'modified' => '2025-03-20 11:31:10',
            ],
        ];
        parent::init();
    }
