...
/**
 * CmsPagesImagesFixture
 */
class CmsPagesImagesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'cms_image_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'cms_image_id' => 1,
                'sort' => 1,
                'created' => '2025-03-20 11:31:00',
                'modified' => '2025-03-20 11:31:00',
            ],
        ];
        parent::init();
    }
