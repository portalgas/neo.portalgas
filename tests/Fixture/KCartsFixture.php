 ...
 * KCartsFixture
 */
class KCartsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'qta' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => 'valore di default 0 perche\' se faccio acquisto con INSERT da backoffice il valore va in qta_finale', 'precision' => null, 'autoIncrement' => null],
        'deleteToReferent' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => 'N', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'qta_forzato' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'inStoreroom' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => 'N', 'collate' => 'utf8_general_ci', 'comment' => 'se Y e\' gia\' stato copiato in dispensa', 'precision' => null, 'fixed' => null],
        ...
        'date' => ['type' => 'timestamp', 'length' => null, 'null' => false, 'default' => 'CURRENT_TIMESTAMP', 'comment' => 'data utilizzata per avere l\'ultimo inserito', 'precision' => null],
        '_indexes' => [
