...
/**
 * KCashesHistoriesFixture
 */
class KCashesHistoriesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'cash_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'index_cash_id' => ['type' => 'index', 'columns' => ['cash_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'importo' => 1,
                'created' => '2020-04-09 20:11:43',
                'modified' => '2020-04-09 20:11:43',
            ],
        ];
        parent::init();
    }
