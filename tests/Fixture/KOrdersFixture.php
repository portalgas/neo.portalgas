 ...
 * KOrdersFixture
 */
class KOrdersFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'typeGest' => ['type' => 'string', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'tipologia di gestione a POST delivery', 'precision' => null, 'fixed' => null],
        'state_code' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'mail_open_send' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => 'N', 'collate' => 'utf8_general_ci', 'comment' => 'se Y un cron invia la mail', 'precision' => null, 'fixed' => null],
        ...
        'type_draw' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => 'SIMPLE', 'collate' => 'utf8_general_ci', 'comment' => 'definisce come visualizzare l\'ecommerce', 'precision' => null, 'fixed' => null],
        'tot_importo' => ['type' => 'float', 'length' => 11, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => 'totale importo degli acquisti degli utenti'],
        'qta_massima' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => 'indica qta max di tutti gli acquisti', 'precision' => null, 'autoIncrement' => null],
        'qta_massima_um' => ['type' => 'string', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'indica qta max di tutti gli acquisti', 'precision' => null, 'fixed' => null],
        'send_mail_qta_massima' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => 'Y', 'collate' => 'utf8_general_ci', 'comment' => 'se Y invia mail al referente per qta_massima', 'precision' => null, 'fixed' => null],
        'importo_massimo' => ['type' => 'float', 'length' => 11, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => 'indica importo max di tutti gli acquisti'],
        'send_mail_importo_massimo' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => 'Y', 'collate' => 'utf8_general_ci', 'comment' => 'se Y invia mail al referente per importo_massimo', 'precision' => null, 'fixed' => null],
        'tesoriere_nota' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'tesoriere_fattura_importo' => ['type' => 'float', 'length' => 11, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        ...
        'tesoriere_importo_pay' => ['type' => 'float', 'length' => 11, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'tesoriere_stato_pay' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => 'N', 'collate' => 'utf8_general_ci', 'comment' => 'se Y il produttore e\' stato pagato, ctrl per delivery.stato_elaborazione = CLOSE', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'des_order_id' => 1,
                'data_inizio' => '2020-03-24',
                'data_fine' => '2020-03-24',
                'data_fine_validation' => '2020-03-24',
                'data_incoming_order' => '2020-03-24',
                'data_state_code_close' => '2020-03-24',
                ...
                'mail_open_data' => '2020-03-24 13:42:25',
                'mail_close_data' => '2020-03-24 13:42:25',
                ...
                'created' => '2020-03-24 13:42:25',
                'modified' => '2020-03-24 13:42:25',
            ],
        ];
        parent::init();
    }
