...
/**
 * KRequestPaymentsOrdersFixture
 */
class KRequestPaymentsOrdersFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'delivery_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'request_payment_id' => ['type' => 'index', 'columns' => ['request_payment_id'], 'length' => []],
            'delivery_id' => ['type' => 'index', 'columns' => ['delivery_id'], 'length' => []],
            'order_id' => ['type' => 'index', 'columns' => ['order_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'unique' => ['type' => 'unique', 'columns' => ['organization_id', 'delivery_id', 'order_id', 'request_payment_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'MyISAM',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2023-01-26 12:05:05',
                'modified' => '2023-01-26 12:05:05',
            ],
        ];
        parent::init();
    }
