...
/**
 * KStatDeliveriesFixture
 */
class KStatDeliveriesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'luogo' => ['type' => 'string', 'length' => 156, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
