...
/**
 * KSummaryOrderCostMoresFixture
 */
class KSummaryOrderCostMoresFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'importo_cost_more' => ['type' => 'float', 'length' => 11, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => '0.00', 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'peso' => 1,
                'importo_cost_more' => 1,
                'created' => '2020-12-10 06:41:37',
                'modified' => '2020-12-10 06:41:37',
            ],
        ];
        parent::init();
    }
