...
/**
 * KSummaryOrderTrasportsFixture
 */
class KSummaryOrderTrasportsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'importo_trasport' => ['type' => 'float', 'length' => 11, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => '0.00', 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'peso' => 1,
                'importo_trasport' => 1,
                'created' => '2020-12-10 06:41:15',
                'modified' => '2020-12-10 06:41:15',
            ],
        ];
        parent::init();
    }
