...
/**
 * KTemplatesDesOrdersStatesOrdersActionsFixture
 */
class KTemplatesDesOrdersStatesOrdersActionsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'des_order_action_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'sort' => ['type' => 'integer', 'length' => 11, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['template_id', 'state_code', 'group_id', 'des_order_action_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'MyISAM',
    ...
    public function init()
    {
        $this->records = [
            [
                'template_id' => 1,
                'group_id' => 1,
                'state_code' => 'f1f7d0d3-756a-4398-b59c-7a1382a435d7',
                'des_order_action_id' => 1,
                'sort' => 1,
            ],
        ];
        parent::init();
