...
class OrdersTypesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'code' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_default_end' => 1,
                'sort' => 1,
                'created' => '2020-07-03 09:41:08',
                'modified' => '2020-07-03 09:41:08',
            ],
        ];
        parent::init();
    }
