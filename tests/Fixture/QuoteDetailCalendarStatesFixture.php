...
/**
 * QuoteDetailCalendarStatesFixture
 */
class QuoteDetailCalendarStatesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'modiifed' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_system' => 1,
                'created' => '2019-06-05 10:25:50',
                'modiifed' => '2019-06-05 10:25:50'
            ],
        ];
        parent::init();
    }
