...
class QuotesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'offer_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'year' => ['type' => 'string', 'fixed' => true, 'length' => 4, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null],
        ...
        'data_acceptance' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => 'quando da offer a quotes', 'precision' => null],
        'data_close' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'quote_state_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_ini' => '2019-10-03',
                'data_fine' => '2019-10-03',
                'data_acceptance' => '2019-10-03',
                'data_close' => '2019-10-03',
                'quote_state_id' => 1,
                'price_work' => 1,
                'created' => '2019-10-03 16:13:48',
                'modified' => '2019-10-03 16:13:48'
            ],
        ];
        parent::init();
    }
