...
function OrganizationPays() {

    if (!(this instanceof OrganizationPays)) {
        throw new TypeError("OrganizationPays constructor cannot be called as a function.");
    }
...
OrganizationPays.prototype = {
    constructor: OrganizationPays, //costruttore
    ...
    bindEvents: function () {
        ...
        console.log("OrganizationPays bindEvents");
    ...
    init: function () {
        console.log("OrganizationPays.init");
        var _this = this;
